...
const ErrorPage = () => {
    ...
    const { data } = error;
    return (
        <section className="flex items-center h-screen sm:p-16 bg-gray-200 text-gray-800">
            <div className="container flex flex-col items-center justify-center px-5 mx-auto my-8 space-y-8 text-center sm:max-w-md">
                ...
                <Link to="/" className="btn btn-error hover:scale-105 transition">Back to homepage</Link>
            </div>
        </section>
    );
};
